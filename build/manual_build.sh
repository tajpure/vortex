...
node_modules/.bin/electron-packager dist Vortex --out=releases --platform=linux --arch=ia32 --version=1.2.0 app-version=1.0 --icon=resources/linux/icon.ico --asar=true --overwrite

node_modules/.bin/electron-packager dist Vortex --out=releases --platform=linux --arch=x64 --version=1.2.0 app-version=1.0 --icon=resources/windows/icon.ico --asar=true --overwrite
